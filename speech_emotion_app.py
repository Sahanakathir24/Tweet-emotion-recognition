...
# load models
model = load_model(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\model3.h5")
...
#@staticmethod
def speech_emotion_recognition_app():
    st.title("Speech Emotion Recognition")
    side_img = Image.open(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\images\emotion3.jpg")
    with st.sidebar:
    ...
    if website_menu == "Emotion Recognition":
        ...
        model_type = st.sidebar.selectbox("Model", ("mfccs", "none"))
            ...
            with col1:
                ...
                if audio_file is not None:
                    ...
                    if st.button("Try test file"):
                        wav, sr = librosa.load(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\test.wav", sr=44100)
                        Xdb = get_melspec(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\test.wav")[1]
                        mfccs = librosa.feature.mfcc(y=wav, sr=sr)
                        # display audio
                        st.audio(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\test.wav", format='audio/wav', start_time=0)
                        path = r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\test.wav"
                        audio_file = "test"
            with col2:
                if audio_file is not None:
                    ...
                    fig.set_facecolor('#d1d1e0')
                    plt.title("Wave-form")
                    y,sr=librosa.load(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\test.wav")
        ...
        if audio_file is not None:
            ...
            if model_type == "mfccs":
                ...
                with st.container():
                    ...
                    z=model.input_shape[-1]
                    mfccs = get_mfccs(path,z)
                    ...
                    with col3:
                        if em7:
                            model_ = load_model(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\model4.h5")
                    ...
                    with col4:
                        if gender:
                            with st.spinner('Wait for it...'):
                                gmodel = load_model(r"C:\Users\91944\Downloads\speech-emotion-webapp-master\speech-emotion-webapp-master\model_mw.h5")
...
if __name__ == '__main__':
    speech_emotion_recognition_app()
